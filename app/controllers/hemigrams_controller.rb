...
class HemigramsController < ApplicationController
  ...
  def create
    ...
    if @hemigram.save
      respond_to do |format|
        ...
        # check turbo stream CREATE views/hemigrams/create.turbo_stream.haml
  ...
  def update
    if @hemigram.update(hemigram_params)
      respond_to do |format|
        ...
        # check turbo stream UPDATE view, views/hemigrams/update.turbo_stream.haml
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      # check turbo stream DESTROY view, views/hemigrams/destroy.turbo_stream.haml
