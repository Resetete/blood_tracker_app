...
unless Admin::BloodCellDescription.find_by(title: 'Hemoglobin (Hb)')
  ...
  p 'Hemoglobin description created'
else
  p 'Hemoglobin description already exists'
end

unless Admin::BloodCellDescription.find_by(title: 'Hematocrit (Hct)')
  ...
  p 'Hematocrit description created'
else
  p 'Hematocrit description already exists'
end

unless Admin::BloodCellDescription.find_by(title: 'Complete blood count (CBC)')
  ...
  p 'Blood count description created'
else
  p 'Blood count description already exists'
end

unless Admin::BloodCellDescription.find_by(title: 'Coagulation')
  ...
  p 'Coagulation description created'
else
  p 'Coagulation description already exists'
end

unless Admin::BloodCellDescription.find_by(title: 'Anticoagulants')
  ...
  p 'Anticoagulants description created'
else
  p 'Anticoagulants description already exists'
end

unless Admin::BloodCellDescription.find_by(title: 'Blood types')
  ...
  p 'Blood types description created'
else
  p 'Blood types description already exists'
end
