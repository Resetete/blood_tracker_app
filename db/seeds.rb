...
[
  ...
  { :parameter_name=>"red_blood_cells", :abbreviations=>["RBC", "erythrocytes"], :chart_unit=>"10^6/μL", :upper_limit=>6.0, :lower_limit=>4.5},
  { :parameter_name=>"white_blood_cells", :abbreviations=>["WBC", "leukocytes"], :chart_unit=>"10^6/μL", :upper_limit=>11.0, :lower_limit=>4.0},
  { :parameter_name=>"mean_corpuscular_hemoglobin", :abbreviations=>["MCH"], :chart_unit=>"pg", :upper_limit=>34.0, :lower_limit=>27.0},
  { :parameter_name=>"mean_corpuscular_hemoglobin_concentration", :abbreviations=>["MCHC"], :chart_unit=>"g/dl", :upper_limit=>36.0, :lower_limit=>32.0},
  { :parameter_name=>"red_cell_distribution_width", :abbreviations=>["RDW"], :chart_unit=>"%", :upper_limit=>16.0, :lower_limit=>11.0},
  ...
  { :parameter_name=>"neutrophils", :abbreviations=>["NEUT", "Neutro"], :chart_unit=>"%", :upper_limit=>70.0, :lower_limit=>40.0},
  ...
  { :parameter_name=>"mean_corpuscular_volume", :abbreviations=>["MCV"], :chart_unit=>"fL", :upper_limit=>100.0, :lower_limit=>80.0},
  { :parameter_name=>"platelet_distribution_width", :abbreviations=>["PDW"], :chart_unit=>"fL", :upper_limit=>20.0, :lower_limit=>9.0},
